    ...
    <div style={{ padding: '20px', textAlign: 'center' }}>
      ...
      <Grid container spacing={12} justifyContent="center" sx={{ marginTop: 0}}>
        <Grid item xs={12} sm={6} md={4} sx={{marginBottom: 60}}>
          <CardActionArea onClick={() => navigate('/sec-view')}>
            <Card sx={{ display: 'flex', flexDirection: 'row', alignItems: 'center', width: 300, padding: 2 }}>
              <Box component="img" src={img1} alt="Master View" sx={{ width: 80, height: 80, marginRight: 2, borderRadius: '8px' }} />
        ...
        <Grid item xs={12} sm={6} md={4}>
          <CardActionArea onClick={() => navigate('/sec-upload')}>
            <Card sx={{ display: 'flex', flexDirection: 'row', alignItems: 'center', width: 300, padding: 2, marginRight: 50 }}>
              <Box component="img" src={img2} alt="Uploader" sx={{ width: 80, height: 80, marginRight: 2, borderRadius: '8px', }} />
              <CardContent sx={{ textAlign: 'center' }}>
